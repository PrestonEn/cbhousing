...
<div class="col-md-8 col-sm-8">
	<div class="titlearea col-md-8 ">
		...
		<div class="col-md-12 infobar">
			<div class="col-md-4 metric ">
				...
				<h4>{{$data['property']->distance}}km</h4>
			</div>
			<div class="col-md-4 metric">
	...
	<div class='col-md-4  col-sm-6'>
		<div class="image-row">
			<h5 class="pricecell orange">${{$room->price}}/m</h5>
			<div class="image-set">
			...
			<div class='capti'>
				<h5 class="warning">
					...
					@else	
		 				<h5>Availability: {{$room->available}}</h5>
	            ...
	            @else
	            	<a href="{{ url('/auth/register') }}">
	            		<h3 class="text-sub">Register to request this room.</h3>
	            	</a>
	            @endif
			</div>
		</div>
